...
import styles from "./career-coaching.module.css";
...
const offerCards = [
  {
    ...
    text: "We conduct an in-depth analysis of your current career situation, skills, and aspirations.",
    Icon: ClipboardCheck
  },

  {
    title: "Goal Setting and Action Planning",
    text: "Develop a strategic plan with clear, achievable goals to guide your career progression.",
    Icon: Target
  },

  {
    title: "Skill Development",
    text: "Access to training programs that enhance your technical and soft skills, making you a more versatile candidate.",
    Icon: BarChart3
  },

  {
    title: "Resume and LinkedIn Profile Enhancement",
    text: "Craft a compelling resume that highlights your achievements and experiences.",
    Icon: FileText
  },

  {
    title: "Interview Preparation",
    text: "Practice with simulated interviews tailored to your desired role and industry.",
    Icon: UserRoundCheck
  },

  {
    title: "Job Search Strategies",
    text: "Gain insights into the latest industry trends and job market conditions.",
    Icon: SearchCheck
  }
...
const faqs = [
  {
    ...
    answer:
      "Career coaching is personalized guidance aimed at enhancing your career growth, refining skills, and achieving professional objectives with focused strategies."
  },

  {
    question: "Who benefits from career coaching?",
    answer:
      "Professionals at any career stage seeking advancement, career change, or improvement in job performance can benefit from career coaching."
  },

  {
    question: "How can career coaching help me?",
    answer:
      "It offers personalized strategies for goal setting, skill development, job search optimization, and overcoming career challenges."
  },

  {
    question: "What should I expect from a coaching session?",
    answer:
      "Each session provides a confidential space for discussing goals, receiving feedback, and developing actionable plans for career success."
  }
...
const achievements = [

  {
    ...
    text:
      "Numerous clients have successfully transitioned to new roles, advanced their careers, and achieved their professional goals through our coaching programs.",
...

  {
    ...
    text:
      "Our career coaching services boast a 95% satisfaction rate, with clients praising the personalized guidance and practical advice they received.",
...

  {
    title: "Proven Impact",
    text:
      "Over 80% of our clients have reported significant improvements in their job search strategies, interview skills, and overall career development.",
    ...
    <header className={shared.mainHeader}>
      <div className={shared.autoContainer}>
        <div className={shared.headerOuter}>
          ...
          <button
            aria-controls="career-coaching-mobile-menu"
...
function MobileMenu({ mobileOpen, setMobileOpen }) {
  ...
  return (
    <div className={cx(shared.mobileMenu, mobileOpen && shared.mobileMenuOpen)} id="career-coaching-mobile-menu" aria-hidden={!mobileOpen}>
  ...
  return (
    ...
    <section className={styles.hero} data-coaching-reveal>
      ...
      <div className={styles.heroContent}>
        ...
        <h1>
          Career Coaching at <span>Jscale</span>
        </h1>
        ...
        <div className={styles.introGrid}>
          ...
          <div className={styles.imageStack} data-coaching-reveal>
            ...
            <figure className={styles.imageOne}>
              <img src="/assets/jscale-media/en/assets/images/resource/about-1.jpg" alt="Career coaching meeting" />
            </figure>

            <figure className={styles.imageTwo}>
              <img src="/assets/jscale-media/en/assets/images/resource/about-2.jpg" alt="Professional career planning" />
            </figure>
          ...
          <div className={styles.introCopy} data-coaching-reveal>
            ...
            <span className={styles.subTitle}>Career Coaching Services</span>
            <h2>At Jscale</h2>

            <p>
              At Jscale, we understand that navigating the complexities of your career path can be challenging.
              Whether you feel stuck, uninspired, or simply unsure of your next steps, our comprehensive career coaching
              services are designed to help you unlock your full potential and achieve your professional goals.
            </p>
      ...
      <div className={shared.autoContainer}>
        <div className={styles.faqGrid}>
          ...
          <div className={styles.processCopy} data-coaching-reveal>
            ...
            <h5>
              Discover how Jscale's career coaching service can empower you to achieve your professional aspirations.
              Our expert coaches provide personalized guidance tailored to your career goals, helping you navigate challenges and seize opportunities effectively.
            </h5>
    ...
    <section className={styles.achievementSection}>
      <div className={shared.autoContainer}>
        ...
        <div className={styles.sectionTitle} data-coaching-reveal>
          ...
          <h2>Accomplishments and Milestones</h2>
        </div>
...
function Subscribe() {
  return (
    <SubscribeBox
      styles={shared}
      source="career-coaching-page"
      idPrefix="career-coaching-subscribe"
